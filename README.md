...
> **资源索引和导航平台** - 完整功能和下载请访问主站 [panbox.cc](https://panbox.cc)
...
- 🌐 [访问主站点](https://panbox.cc)
- 📋 [资源列表](https://panbox.cc/resources)
- 📂 [分类导航](https://panbox.cc/categories)
- 📄 [GitHub Pages](https://LoneKingCode.github.io/panbox)

## 📊 统计信息

- **总资源数**: 170
- **分类数量**: 12
- **最后更新**: 2025-11-24 12:11:38

## 📝 使用说明

本仓库是**资源索引平台**，通过自动化脚本每日同步资源信息，提供资源索引和导航功能。

**🎯 重要提示**: 这是资源索引和导航页面，完整功能和下载请访问主站。

👉 **[访问主站 https://panbox.cc 获取完整功能](https://panbox.cc)** 👈

### 🔍 搜索资源

1. 使用 GitHub 搜索功能（右上角搜索框）
2. 按分类浏览资源
3. 访问主站点进行高级搜索
